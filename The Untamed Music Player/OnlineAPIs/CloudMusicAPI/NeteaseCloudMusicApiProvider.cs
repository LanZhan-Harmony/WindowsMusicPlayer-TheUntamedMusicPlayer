...
public static partial class CloudMusicApiProviders
{
    ...
    public static readonly NeteaseCloudMusicApiProvider Banner = new(
        ...
        [
            new("clientType", ParameterType.Optional, "pc")
            {
                KeyForwarding = "type",
                Transformer = BannerTypeTransformer,
            },
        ],
    ...
    )
    {
        DataProvider = queries =>
        {
            ...
            data = new QueryCollection { { "e_r", "true" } };
    ...
    public static readonly NeteaseCloudMusicApiProvider CaptchaSent = new(
        ...
        [new("cellphone") { KeyForwarding = "phone" }, new("ctcode", ParameterType.Optional, "86")],
        BuildOptions("weapi")
    );
    ...
    public static readonly NeteaseCloudMusicApiProvider Comment = new(
        ...
        HttpMethod.Post,
        q =>
            $"https://music.163.com/weapi/resource/comments/{(q["t"] == "1" ? "add" : q["t"] == "0" ? "delete" : "reply")}",
        [],
    ...
    public static readonly NeteaseCloudMusicApiProvider CommentHot = new(
        ...
        HttpMethod.Post,
        q =>
            $"https://music.163.com/weapi/v1/resource/hotcomments/{CommentTypeTransformer(q["type"])}{q["id"]}",
        [
            new("rid") { KeyForwarding = "id" },
            new("limit", ParameterType.Optional, "20"),
            new("offset", ParameterType.Optional, "0"),
    ...
    public static readonly NeteaseCloudMusicApiProvider CommentLike = new(
        ...
        [
            ...
            new("threadId", ParameterType.SpecialHandle, null)
            {
                SpecialHandler = q =>
                    q["type"] == "6" ? q["threadId"] : CommentTypeTransformer(q["type"]) + q["id"],
            },
        ],
        BuildOptions("weapi", [new("os", "pc")])
    );
    ...
    public static readonly NeteaseCloudMusicApiProvider DjHot = new(
        ...
        [new("limit", ParameterType.Optional, "30"), new("offset", ParameterType.Optional, "0")],
        BuildOptions("weapi")
    );
    ...
    public static readonly NeteaseCloudMusicApiProvider DjProgramToplist = new(
        ...
        [new("limit", ParameterType.Optional, "100"), new("offset", ParameterType.Optional, "0")],
        BuildOptions("weapi")
    );
    ...
    public static readonly NeteaseCloudMusicApiProvider Follow = new(
        ...
        HttpMethod.Post,
        q =>
            $"https://music.163.com/weapi/user/{(q["t"] == "1" ? "follow" : "delfollow")}/{q["id"]}",
        [],
        BuildOptions("weapi", [new("os", "pc")])
    );
    ...
    public static readonly NeteaseCloudMusicApiProvider HotTopic = new(
        ...
        [new("limit", ParameterType.Optional, "20"), new("offset", ParameterType.Optional, "0")],
        BuildOptions("weapi")
    );
    ...
    public static readonly NeteaseCloudMusicApiProvider Like = new(
        ...
        HttpMethod.Post,
        q =>
            $"https://music.163.com/weapi/radio/like?alg={q.GetValueOrDefault("alg", "itembased")}&trackId={q["id"]}&time={q.GetValueOrDefault("time", "25")}",
        [new("trackId") { KeyForwarding = "id" }, new("like")],
        BuildOptions("weapi")
    );
    ...
    public static readonly NeteaseCloudMusicApiProvider MvAll = new(
        ...
        [
            new("tags", ParameterType.SpecialHandle, null)
            {
                SpecialHandler = q =>
    ...
    public static readonly NeteaseCloudMusicApiProvider MvUrl = new(
        ...
        [new("id"), new("r", ParameterType.Optional, "1080") { KeyForwarding = "res" }],
        BuildOptions("weapi")
    );
    ...
    public static readonly NeteaseCloudMusicApiProvider PlaylistSubscribe = new(
        ...
        HttpMethod.Post,
        q =>
            $"https://music.163.com/weapi/playlist/{(q["t"] == "1" ? "subscribe" : "unsubscribe")}",
        [new("id")],
        BuildOptions("weapi")
    );
    ...
    public static readonly NeteaseCloudMusicApiProvider PlaylistTracks = new(
        ...
        [new("op"), new("pid"), new("trackIds") { Transformer = JsonArrayTransformer }],
        BuildOptions("weapi")
    );
        ...
        {
            {
                ...
                $"{{\"id\":{queries["id"]},\"name\":\"{queries["name"]}\"}}"
            },
            {
                "/api/playlist/desc/update",
                $"{{\"id\":{queries["id"]},\"desc\":\"{queries["desc"]}\"}}"
            },
            {
                "/api/playlist/tags/update",
                $"{{\"id\":{queries["id"]},\"tags\":\"{queries["tags"]}\"}}"
            },
        },
    };
    ...
    public static readonly NeteaseCloudMusicApiProvider PlaymodeIntelligenceList = new(
        ...
        [
            ...
            new("startMusicId", ParameterType.SpecialHandle, null)
            {
                SpecialHandler = q => q.TryGetValue("sid", out var sid) ? sid : q["id"],
            },
    ...
    public static readonly NeteaseCloudMusicApiProvider ResourceLike = new(
        ...
        [
            ...
            {
                SpecialHandler = q =>
                    q["type"] == "6" ? q["threadId"] : ResourceTypeTransformer(q["type"]) + q["id"],
            },
        ],
        BuildOptions("weapi", [new("os", "pc")])
    );
    ...
    public static readonly NeteaseCloudMusicApiProvider Scrobble = new(
        ...
        [
            new("logs", ParameterType.SpecialHandle, null)
            {
                SpecialHandler = q =>
                    JsonSerializer.Serialize(
                        new QueryCollection
    ...
    public static readonly NeteaseCloudMusicApiProvider SearchDefault = new(
        ...
        [],
        BuildOptions("eapi", null, null, "/api/search/defaultkeyword/get")
    );
    ...
    public static readonly NeteaseCloudMusicApiProvider SearchMultimatch = new(
        ...
        [new("s") { KeyForwarding = "keywords" }, new("type", ParameterType.Optional, "1")],
        BuildOptions("weapi")
    );
    ...
    public static readonly NeteaseCloudMusicApiProvider TopSong = new(
        ...
        [new("areaId") { KeyForwarding = "type" }, new("total", ParameterType.Constant, "true")],
        BuildOptions("weapi")
    );
    ...
    public static readonly NeteaseCloudMusicApiProvider UserRecord = new(
        ...
        [new("uid"), new("type", ParameterType.Optional, "1")],
        BuildOptions("weapi")
    );
