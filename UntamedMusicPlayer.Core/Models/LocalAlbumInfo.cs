...
public class LocalArtistAlbumInfo : IArtistAlbumInfoBase
{
    public LocalArtistAlbumInfo(
        LocalAlbumInfo localAlbumInfo,
        IEnumerable<IBriefSongInfoBase>? songs = null,
        string? coverPath = null
    )
    {
        ArgumentNullException.ThrowIfNull(localAlbumInfo);
        Name = localAlbumInfo.Name;
        YearStr = IArtistAlbumInfoBase.GetYearStr(localAlbumInfo.Year);
        CoverPath = coverPath ?? localAlbumInfo.CoverPath;
